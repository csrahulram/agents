...
# Sources cited in the knowledge base

Every external reference behind the notes, grouped by note. PDFs of the key papers live beside this file
(not committed — run `python knowledge/papers/fetch.py` to download them).
...
- https://arxiv.org/pdf/2604.13602
- https://arxiv.org/pdf/2604.15149
